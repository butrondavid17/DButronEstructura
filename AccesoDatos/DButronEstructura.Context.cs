...
namespace AccesoDatos
{
    ...
    public partial class DButronEstructuraEntities : DbContext
    {
        public DButronEstructuraEntities()
            : base("name=DButronEstructuraEntities")
        {
        }
        ...
        public virtual ObjectResult<EmpleadoGetByName_Result> EmpleadoGetByName(string nombre)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EmpleadoGetByName_Result>("EmpleadoGetByName", nombreParameter);
        }
